...
def get_industry_level_practice_breakdown(labeled_industry_articles, industry_to_sector_map, sector=0, industry=0,
    ...
    col_name_pterm_article_or_event = "Yearly LSCS Article count of practice term (any outcome term)" if article_level else "Yearly LSCS Event count of practice term (any outcome term)"
    ...
    col_name_pterm_rterm_article_or_event = "Yearly LSCS Article count of co-occurrence (one outcome term)" if article_level else "Yearly LSCS Event count of co-occurrence (one outcome term)"
...
if __name__ == '__main__':
    ...
    col_name_pterm_article_or_event = "Yearly LSCS Article count of practice term (any outcome term)" if args.article_level else "Yearly LSCS Event count of practice term (any outcome term)"
    ...
    col_name_pterm_rterm_article_or_event = "Yearly LSCS Article count of co-occurrence (one outcome term)" if args.article_level else "Yearly LSCS Event count of co-occurrence (one outcome term)"
